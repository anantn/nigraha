                  ...
                  <td bgcolor="#000000">
                    <table border="0" width="100%" cellspacing="0" cellpadding="3">
                      <tr>
                          ...
                          <p>
                            <?php
                                ...
                                if (($arr['semester'] == 6) and (isset($_POST['miniproj'])) and (trim($_POST['facultymp']) != ''))
                                    $courses[] = trim($_POST['facultymp'])." - MiniProject";
                                $toadd = serialize($courses);
                                $squery = mysql_query("UPDATE students SET courses='".$toadd."' WHERE userid = '".$arr['userid']."'");
                            ?>
                            Congratulations! All Done!<br>
                            You have been registered for the following courses:
                            ...
                            <table width="100%" border="0">
                              ...
                              <tr>
                                ...
                                <td><center><strong>Catogory</strong></center></td>
                              </tr>
                              <?php 
                                mysql_select_db("mnit_master", $conn1);
                                $credits=0;
                        ...
                        <p>
			  <b>Thank you for your time, Your registration has been
              completed!<br/>
              We request you for feedback on the online registration experience:
              send an email to anant@kix.in (or) gaurms@gmail.com.<br/>
			  Sysadmins will get in touch with you if there are
			  problems with your Demand Draft or your form.<br/>
			  Have a good day!
                        </p>
                        <p><a href="http://172.16.1.20/">NEW REGISTRATION</a></p>
			</td>
                      </tr>
                    </table>
                  </td>
