                        ...
                        <td width="99%" valign="top" bgcolor="#E0E0E0">
                          ...
                          <form name="coursechoice" method="post" action="submitchoices.php">
                            ...
                            <table width="100%" border="1">
                              ...
                              <?php 
                                $count=0;
                                foreach($electives->dept as $dept) {
                                  if($dept['id']==$arr['dept'] and $dept['semester']==$arr['semester'] and $dept['type']=='IC') {
                                    $count++;
                                    $throwic = mysql_query("SELECT * FROM syllabus WHERE code='".$dept->course."'");
                                    $ic = mysql_fetch_assoc($throwic);
                                    echo "
                                        <tr>
                                            <td><center><input type=\"text\" id=\"add".$count."\" name=\"add".$count."\" value=\"".$ic['code']."\" size=\"7\" maxlength=\"6\" /></center></td>
                                            <td><center><div id=\"addtitle".$count."\">".$ic['title']."</div></center></td> 
                                            <td><center><div id=\"addcredit".$count."\">".$ic['credits']."</div></center></td>
                                        </tr>";
                                    }
                                  }
                                  $que = mysql_query("SELECT * FROM syllabus WHERE semester='".$arr['semester']."' and dept='".$arr['dept']."' and area!='DE' ") or die(mysql_error());
                                ...
                                foreach($electives->dept as $dept) {
                                  if($dept['id']==$arr['dept'] and $dept['semester']==$arr['semester'] and $dept['type']!='IC') {
                                    ...
                                    while($number) {
                                      ...
                                      echo "
                                        <tr>
                                            <td><center><input type=\"text\" id=\"add".$count."\" name=\"add".$count."\" value=\"\" size=\"7\" maxlength=\"6\" /></center></td>
                                ...
                                if ($arr['semester'] == 6 and (($arr['dept'] == 'CP') or ($arr['dept'] == 'IT'))) {
                                    echo "
                                    <tr>
                                        <td colspan=\"3\">&nbsp;</td>
                                    </tr>
                          ...
                          <script language="JavaScript" type="text/javascript">
                            ...
                            gotResponse = function(daid, req)
                            {
                                ...
                                if (MochiKit.Base.compare(code.value, 303))
                                {
                                ...
                                {
                                    editTitle.innerHTML = ""; editCredits.innerHTML = "";
                                }
                            }
                            ...
                            {
                                var box = (which.src());
                                var req = loadXMLDoc("anant/web/getCourseReq.xml");
