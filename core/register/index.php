...
<head>
  <title>MNIT Registration Step 1</title>
                    ...
                    <table border="0" width="100%" cellspacing="0" cellpadding="3">
                      <tr>
                        <td valign="top" bgcolor="#E0E0E0">
                          <p align="justify"><font face="Verdana, Arial, Helvetica, sans-serif">ONLINE REGISTRATION CLOSED</font></p>

                          <p align="justify"><font face="Verdana, Arial, Helvetica, sans-serif">At any point in time, if you face any difficulty or an unexpected behaviour from the software please notify the sysadmins immediately<br/>(Anant or Rahul - 3rd Year CP). You can also email your suggestions to: anant@kix.in and cc: gaurms@gmail.com</font></p>
<!--
                          <form name="form1" method="post" action="validate.php">
                            <table width="100%" border="0">
                              <tr>
                                <td width="243"><font face="Arial, Helvetica, sans-serif">Your UserID:</font></td>
                              ...
                              <tr>
                                <td><font face="Arial, Helvetica, sans-serif">Your Temporary Password:</font></td>

                                <td><input name="password" type="password" id="password" size="16" maxlength="10"></td>
                              </tr>
  ...
  frmvalidator.addValidation("password","req", "Please enter the password given to you!");
  frmvalidator.addValidation("password","maxlen=8","Invalid password");
  frmvalidator.addValidation("password","minlen=8","Invalid password");
        </script>-->
