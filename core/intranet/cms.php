...
<html>
<head>
<title>Welcome to the MNIT CMS!</title>
		...
		<table border="0" cellpadding="5" cellspacing="0">
			<tr>
					...
					<td valign="top" class="rightColumn">
						...
						<p class="subHeader">
							The Basic Structure of the site is displayed below. Click on any table to edit it.
					       <p>
                                                         <ul>
                                                                <li><a href="cmsmain.php?table=academics">Academic</a></li>
                                                                <li><a href="cmsmain.php?table=administration">Administration</a></li>
                                                                <li><a href="cmsmain.php?table=research">Research</a></li>
                                                                <li><a href="cmsmain.php?table=students">Students</a></li>
                                                                <li><a href="cmsmain.php?table=institute">Institute</a></li>
                                                                <li><a href="cmsmain.php?table=visitorsguide">Visitor's Guide</a></li>
							</ul>
							<br>To Edit the Home page click on any table. Please ensure that you fully understand the way the data is stored on the database before undertaking any changes! In case of any doubt or for more info, refer the IntraDocs or contact any SysAdmin.
						</p>
				</td>
			</tr>
		</table>
