...
<?php
	...
	{	if($_POST['type']=="student")
		...
		echo "</p><span class=\"style1\">If the page is blank, no results were found! <a href=\"msearch.php\">Click here</a> to search again. You can click on a user's entry to edit his/her access levels.</span>";
	}
	else
	{
?>
<form action="msearch.php" method="post" name="form1" class="style1">
